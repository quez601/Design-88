(function () {
    ...
    $(document).ready(function () {
        ...
        $('#feedbackForm input, #feedbackForm textarea').change(function () {
            ...
            if ($(this).val()) {
                checkBox.removeClass('glyphicon-unchecked').addClass('glyphicon-check').css({ color: 'white' });
            } else {
...
$("#faq-search").keyup(function () {
    ...
    $(".fr-accordion .item, .fr-accordion h2").each(function () {
    ...
    $("#filter-count").text(+count + " result(s) found");
    ...
    //prevent enter key from clearing the form
